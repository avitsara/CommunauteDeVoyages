...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\CrudTripController' => 'getCrudTripControllerService',
            ...
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.property_image' => 'getSmartUniqueNamer_PropertyImageService',
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JtNZRlEfwS', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
        ...
        return [
            ...
            'vich_uploader.mappings' => [
                'property_image' => [
                    ...
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.property_image',
                        'options' => [
