...
class getLoginFormControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.KXUHpSD'] ?? $container->load('get_ServiceLocator_KXUHpSDService'))->withContext('App\\Controller\\LoginFormController', $container));
