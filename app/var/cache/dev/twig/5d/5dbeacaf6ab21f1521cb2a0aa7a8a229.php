...
<div class=\"container\">
      ...
      ";
        ...
        // line 26
        echo "            ";
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["tripCreationForm"]) || array_key_exists("tripCreationForm", $context) ? $context["tripCreationForm"] : (function () { throw new RuntimeError('Variable "tripCreationForm" does not exist.', 26, $this->source); })()), "image", [], "any", false, false, false, 26), 'row', ["attr" => ["class" => "form-group"]]);
        echo "
     ...
     ";
        // line 33
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["tripCreationForm"]) || array_key_exists("tripCreationForm", $context) ? $context["tripCreationForm"] : (function () { throw new RuntimeError('Variable "tripCreationForm" does not exist.', 33, $this->source); })()), 'form_end');
        echo "
</div>
...
";
    ...
    {
        return array (  145 => 33,  140 => 30,  133 => 26,  129 => 24,  124 => 22,  119 => 20,  114 => 18,  109 => 16,  105 => 15,  101 => 14,  97 => 13,  93 => 12,  85 => 7,  78 => 6,  65 => 4,  48 => 1,  28 => 2,);
    }
...
<div class=\"container\">
      ...
      {{ form_start(tripCreationForm) }}
            ...
            {## IMAGE QUE L'ON VEUT UPLOADER ##}
            {{ form_row(tripCreationForm.image,{'attr':{'class':'form-group'}}) }}
...
{% endblock %}
", "trip/trip.html.twig", "/home/fullmetal/Documents/CommunauteDeVoyages/app/templates/trip/trip.html.twig");
    }
}
