...
class __TwigTemplate_5a7c9e722597d563df556bc4ec1c554d extends Template
{
    private $source;
    private $macros = [];
...
<br>
    ...
    <a href=\"";
        // line 56
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["trip"]) || array_key_exists("trip", $context) ? $context["trip"] : (function () { throw new RuntimeError('Variable "trip" does not exist.', 56, $this->source); })()), "id", [], "any", false, false, false, 56)]), "html", null, true);
        echo "\">edit</a>
...
<br>
    ...
    <a href=\"{{ path('edit', {'id': trip.id}) }}\">edit</a>
